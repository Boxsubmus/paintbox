...
public static class Raylib
{
	...
	/// Light Gray
	public const Color32 LIGHTGRAY = Color32(200, 200, 200, 255);
	
	/// Gray
	public const Color32 GRAY = Color32(130, 130, 130, 255);
	
	/// Dark Gray
	public const Color32 DARKGRAY = Color32(80, 80, 80, 255);
	
	/// Yellow
	public const Color32 YELLOW = Color32(253, 249, 0, 255);
	
	/// Gold
	public const Color32 GOLD = Color32(255, 203, 0, 255);
	
	/// Orange
	public const Color32 ORANGE = Color32(255, 161, 0, 255);
	
	/// Pink
	public const Color32 PINK = Color32(255, 109, 194, 255);
	
	/// Red
	public const Color32 RED = Color32(230, 41, 55, 255);
	
	/// Maroon
	public const Color32 MAROON = Color32(190, 33, 55, 255);
	
	/// Green
	public const Color32 GREEN = Color32(0, 228, 48, 255);
	
	/// Lime
	public const Color32 LIME = Color32(0, 158, 47, 255);
	
	/// Dark Green
	public const Color32 DARKGREEN = Color32(0, 117, 44, 255);
	
	/// Sky Blue
	public const Color32 SKYBLUE = Color32(102, 191, 255, 255);
	
	/// Blue
	public const Color32 BLUE = Color32(0, 121, 241, 255);
	
	/// Dark Blue
	public const Color32 DARKBLUE = Color32(0, 82, 172, 255);
	
	/// Purple
	public const Color32 PURPLE = Color32(200, 122, 255, 255);
	
	/// Violet
	public const Color32 VIOLET = Color32(135, 60, 190, 255);
	
	/// Dark Purple
	public const Color32 DARKPURPLE = Color32(112, 31, 126, 255);
	
	/// Beige
	public const Color32 BEIGE = Color32(211, 176, 131, 255);
	
	/// Brown
	public const Color32 BROWN = Color32(127, 106, 79, 255);
	
	/// Dark Brown
	public const Color32 DARKBROWN = Color32(76, 63, 47, 255);
	
	/// White
	public const Color32 WHITE = Color32(255, 255, 255, 255);
	
	/// Black
	public const Color32 BLACK = Color32(0, 0, 0, 255);
	
	/// Blank (Transparent)
	public const Color32 BLANK = Color32(0, 0, 0, 0);
	
	/// Magenta
	public const Color32 MAGENTA = Color32(255, 0, 255, 255);
	
	/// My own White (raylib logo)
	public const Color32 RAYWHITE = Color32(245, 245, 245, 255);
	...
	[CLink]
	public static extern void UnloadImageColors(Color32 *colors);
	
	/// Unload colors palette loaded with LoadImagePalette()
	[CLink]
	public static extern void UnloadImagePalette(Color32 *colors);
	...
	[CLink]
	public static extern Color32 ColorFromHSV(float hue, float saturation, float value);
	
	/// Get Color structure from hexadecimal value
	[CLink]
	public static extern Color32 GetColor(int32 hexValue);
	
	/// Get Color from a source pixel pointer of certain format
	[CLink]
	public static extern Color32 GetPixelColor(void *srcPtr, int32 format);
	...
	[CLink]
	public static extern void ClearBackground(Color32 color);
	...
	[CLink]
	public static extern void DrawPixel(int32 posX, int32 posY, Color32 color);
	
	/// Draw a pixel using geometry (Vector version) [Can be slow, use with care]
	[CLink]
	public static extern void DrawPixelV(Vector2 position, Color32 color);
	
	/// Draw a line
	[CLink]
	public static extern void DrawLine(int32 startPosX, int32 startPosY, int32 endPosX, int32 endPosY, Color32 color);
	
	/// Draw a line (using gl lines)
	[CLink]
	public static extern void DrawLineV(Vector2 startPos, Vector2 endPos, Color32 color);
	
	/// Draw a line (using triangles/quads)
	[CLink]
	public static extern void DrawLineEx(Vector2 startPos, Vector2 endPos, float thick, Color32 color);
	
	/// Draw lines sequence (using gl lines)
	[CLink]
	public static extern void DrawLineStrip(Vector2 *points, int32 pointCount, Color32 color);
	
	/// Draw line segment cubic-bezier in-out interpolation
	[CLink]
	public static extern void DrawLineBezier(Vector2 startPos, Vector2 endPos, float thick, Color32 color);
	
	/// Draw a color-filled circle
	[CLink]
	public static extern void DrawCircle(int32 centerX, int32 centerY, float radius, Color32 color);
	
	/// Draw a piece of a circle
	[CLink]
	public static extern void DrawCircleSector(Vector2 center, float radius, float startAngle, float endAngle, int32 segments, Color32 color);
	
	/// Draw circle sector outline
	[CLink]
	public static extern void DrawCircleSectorLines(Vector2 center, float radius, float startAngle, float endAngle, int32 segments, Color32 color);
	
	/// Draw a gradient-filled circle
	[CLink]
	public static extern void DrawCircleGradient(int32 centerX, int32 centerY, float radius, Color32 inner, Color32 outer);
	
	/// Draw a color-filled circle (Vector version)
	[CLink]
	public static extern void DrawCircleV(Vector2 center, float radius, Color32 color);
	
	/// Draw circle outline
	[CLink]
	public static extern void DrawCircleLines(int32 centerX, int32 centerY, float radius, Color32 color);
	
	/// Draw circle outline (Vector version)
	[CLink]
	public static extern void DrawCircleLinesV(Vector2 center, float radius, Color32 color);
	
	/// Draw ellipse
	[CLink]
	public static extern void DrawEllipse(int32 centerX, int32 centerY, float radiusH, float radiusV, Color32 color);
	
	/// Draw ellipse outline
	[CLink]
	public static extern void DrawEllipseLines(int32 centerX, int32 centerY, float radiusH, float radiusV, Color32 color);
	
	/// Draw ring
	[CLink]
	public static extern void DrawRing(Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int32 segments, Color32 color);
	
	/// Draw ring outline
	[CLink]
	public static extern void DrawRingLines(Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int32 segments, Color32 color);
	
	/// Draw a color-filled rectangle
	[CLink]
	public static extern void DrawRectangle(int32 posX, int32 posY, int32 width, int32 height, Color32 color);
	
	/// Draw a color-filled rectangle (Vector version)
	[CLink]
	public static extern void DrawRectangleV(Vector2 position, Vector2 size, Color32 color);
	
	/// Draw a color-filled rectangle
	[CLink]
	public static extern void DrawRectangleRec(Rectangle rec, Color32 color);
	
	/// Draw a color-filled rectangle with pro parameters
	[CLink]
	public static extern void DrawRectanglePro(Rectangle rec, Vector2 origin, float rotation, Color32 color);
	
	/// Draw a vertical-gradient-filled rectangle
	[CLink]
	public static extern void DrawRectangleGradientV(int32 posX, int32 posY, int32 width, int32 height, Color32 top, Color32 bottom);
	
	/// Draw a horizontal-gradient-filled rectangle
	[CLink]
	public static extern void DrawRectangleGradientH(int32 posX, int32 posY, int32 width, int32 height, Color32 left, Color32 right);
	
	/// Draw a gradient-filled rectangle with custom vertex colors
	[CLink]
	public static extern void DrawRectangleGradientEx(Rectangle rec, Color32 topLeft, Color32 bottomLeft, Color32 topRight, Color32 bottomRight);
	
	/// Draw rectangle outline
	[CLink]
	public static extern void DrawRectangleLines(int32 posX, int32 posY, int32 width, int32 height, Color32 color);
	
	/// Draw rectangle outline with extended parameters
	[CLink]
	public static extern void DrawRectangleLinesEx(Rectangle rec, float lineThick, Color32 color);
	
	/// Draw rectangle with rounded edges
	[CLink]
	public static extern void DrawRectangleRounded(Rectangle rec, float roundness, int32 segments, Color32 color);
	
	/// Draw rectangle lines with rounded edges
	[CLink]
	public static extern void DrawRectangleRoundedLines(Rectangle rec, float roundness, int32 segments, Color32 color);
	
	/// Draw rectangle with rounded edges outline
	[CLink]
	public static extern void DrawRectangleRoundedLinesEx(Rectangle rec, float roundness, int32 segments, float lineThick, Color32 color);
	
	/// Draw a color-filled triangle (vertex in counter-clockwise order!)
	[CLink]
	public static extern void DrawTriangle(Vector2 v1, Vector2 v2, Vector2 v3, Color32 color);
	
	/// Draw triangle outline (vertex in counter-clockwise order!)
	[CLink]
	public static extern void DrawTriangleLines(Vector2 v1, Vector2 v2, Vector2 v3, Color32 color);
	
	/// Draw a triangle fan defined by points (first vertex is the center)
	[CLink]
	public static extern void DrawTriangleFan(Vector2 *points, int32 pointCount, Color32 color);
	
	/// Draw a triangle strip defined by points
	[CLink]
	public static extern void DrawTriangleStrip(Vector2 *points, int32 pointCount, Color32 color);
	
	/// Draw a regular polygon (Vector version)
	[CLink]
	public static extern void DrawPoly(Vector2 center, int32 sides, float radius, float rotation, Color32 color);
	
	/// Draw a polygon outline of n sides
	[CLink]
	public static extern void DrawPolyLines(Vector2 center, int32 sides, float radius, float rotation, Color32 color);
	
	/// Draw a polygon outline of n sides with extended parameters
	[CLink]
	public static extern void DrawPolyLinesEx(Vector2 center, int32 sides, float radius, float rotation, float lineThick, Color32 color);
	
	/// Draw spline: Linear, minimum 2 points
	[CLink]
	public static extern void DrawSplineLinear(Vector2 *points, int32 pointCount, float thick, Color32 color);
	
	/// Draw spline: B-Spline, minimum 4 points
	[CLink]
	public static extern void DrawSplineBasis(Vector2 *points, int32 pointCount, float thick, Color32 color);
	
	/// Draw spline: Catmull-Rom, minimum 4 points
	[CLink]
	public static extern void DrawSplineCatmullRom(Vector2 *points, int32 pointCount, float thick, Color32 color);
	
	/// Draw spline: Quadratic Bezier, minimum 3 points (1 control point): [p1, c2, p3, c4...]
	[CLink]
	public static extern void DrawSplineBezierQuadratic(Vector2 *points, int32 pointCount, float thick, Color32 color);
	
	/// Draw spline: Cubic Bezier, minimum 4 points (2 control points): [p1, c2, c3, p4, c5, c6...]
	[CLink]
	public static extern void DrawSplineBezierCubic(Vector2 *points, int32 pointCount, float thick, Color32 color);
	
	/// Draw spline segment: Linear, 2 points
	[CLink]
	public static extern void DrawSplineSegmentLinear(Vector2 p1, Vector2 p2, float thick, Color32 color);
	
	/// Draw spline segment: B-Spline, 4 points
	[CLink]
	public static extern void DrawSplineSegmentBasis(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float thick, Color32 color);
	
	/// Draw spline segment: Catmull-Rom, 4 points
	[CLink]
	public static extern void DrawSplineSegmentCatmullRom(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float thick, Color32 color);
	
	/// Draw spline segment: Quadratic Bezier, 2 points, 1 control point
	[CLink]
	public static extern void DrawSplineSegmentBezierQuadratic(Vector2 p1, Vector2 c2, Vector2 p3, float thick, Color32 color);
	
	/// Draw spline segment: Cubic Bezier, 2 points, 2 control points
	[CLink]
	public static extern void DrawSplineSegmentBezierCubic(Vector2 p1, Vector2 c2, Vector2 c3, Vector2 p4, float thick, Color32 color);
	...
	[CLink]
	public static extern Image GenImageColor(int32 width, int32 height, Color32 color);
	
	/// Generate image: linear gradient, direction in degrees [0..360], 0=Vertical gradient
	[CLink]
	public static extern Image GenImageGradientLinear(int32 width, int32 height, int32 direction, Color32 start, Color32 end);
	
	/// Generate image: radial gradient
	[CLink]
	public static extern Image GenImageGradientRadial(int32 width, int32 height, float density, Color32 inner, Color32 outer);
	
	/// Generate image: square gradient
	[CLink]
	public static extern Image GenImageGradientSquare(int32 width, int32 height, float density, Color32 inner, Color32 outer);
	
	/// Generate image: checked
	[CLink]
	public static extern Image GenImageChecked(int32 width, int32 height, int32 checksX, int32 checksY, Color32 col1, Color32 col2);
	...
	[CLink]
	public static extern Image ImageText(char8 *text, int32 fontSize, Color32 color);
	
	/// Create an image from text (custom sprite font)
	[CLink]
	public static extern Image ImageTextEx(Font font, char8 *text, float fontSize, float spacing, Color32 tint);
	
	/// Convert image to POT (power-of-two)
	[CLink]
	public static extern void ImageToPOT(Image *image, Color32 fill);
	...
	[CLink]
	public static extern void ImageAlphaClear(Image *image, Color32 color, float threshold);
	...
	[CLink]
	public static extern void ImageResizeCanvas(Image *image, int32 newWidth, int32 newHeight, int32 offsetX, int32 offsetY, Color32 fill);
	
	/// Modify image color: tint
	[CLink]
	public static extern void ImageColorTint(Image *image, Color32 color);
	
	/// Modify image color: replace color
	[CLink]
	public static extern void ImageColorReplace(Image *image, Color32 color, Color32 replace);
	
	/// Load color data from image as a Color array (RGBA - 32bit)
	[CLink]
	public static extern Color32 * LoadImageColors(Image image);
	
	/// Load colors palette from image as a Color array (RGBA - 32bit)
	[CLink]
	public static extern Color32 * LoadImagePalette(Image image, int32 maxPaletteSize, int32 *colorCount);
	...
	[CLink]
	public static extern Color32 GetImageColor(Image image, int32 x, int32 y);
	
	/// Clear image background with given color
	[CLink]
	public static extern void ImageClearBackground(Image *dst, Color32 color);
	
	/// Draw pixel within an image
	[CLink]
	public static extern void ImageDrawPixel(Image *dst, int32 posX, int32 posY, Color32 color);
	
	/// Draw pixel within an image (Vector version)
	[CLink]
	public static extern void ImageDrawPixelV(Image *dst, Vector2 position, Color32 color);
	
	/// Draw line within an image
	[CLink]
	public static extern void ImageDrawLine(Image *dst, int32 startPosX, int32 startPosY, int32 endPosX, int32 endPosY, Color32 color);
	
	/// Draw line within an image (Vector version)
	[CLink]
	public static extern void ImageDrawLineV(Image *dst, Vector2 start, Vector2 end, Color32 color);
	
	/// Draw a line defining thickness within an image
	[CLink]
	public static extern void ImageDrawLineEx(Image *dst, Vector2 start, Vector2 end, int32 thick, Color32 color);
	
	/// Draw a filled circle within an image
	[CLink]
	public static extern void ImageDrawCircle(Image *dst, int32 centerX, int32 centerY, int32 radius, Color32 color);
	
	/// Draw a filled circle within an image (Vector version)
	[CLink]
	public static extern void ImageDrawCircleV(Image *dst, Vector2 center, int32 radius, Color32 color);
	
	/// Draw circle outline within an image
	[CLink]
	public static extern void ImageDrawCircleLines(Image *dst, int32 centerX, int32 centerY, int32 radius, Color32 color);
	
	/// Draw circle outline within an image (Vector version)
	[CLink]
	public static extern void ImageDrawCircleLinesV(Image *dst, Vector2 center, int32 radius, Color32 color);
	
	/// Draw rectangle within an image
	[CLink]
	public static extern void ImageDrawRectangle(Image *dst, int32 posX, int32 posY, int32 width, int32 height, Color32 color);
	
	/// Draw rectangle within an image (Vector version)
	[CLink]
	public static extern void ImageDrawRectangleV(Image *dst, Vector2 position, Vector2 size, Color32 color);
	
	/// Draw rectangle within an image
	[CLink]
	public static extern void ImageDrawRectangleRec(Image *dst, Rectangle rec, Color32 color);
	
	/// Draw rectangle lines within an image
	[CLink]
	public static extern void ImageDrawRectangleLines(Image *dst, Rectangle rec, int32 thick, Color32 color);
	
	/// Draw triangle within an image
	[CLink]
	public static extern void ImageDrawTriangle(Image *dst, Vector2 v1, Vector2 v2, Vector2 v3, Color32 color);
	
	/// Draw triangle with interpolated colors within an image
	[CLink]
	public static extern void ImageDrawTriangleEx(Image *dst, Vector2 v1, Vector2 v2, Vector2 v3, Color32 c1, Color32 c2, Color32 c3);
	
	/// Draw triangle outline within an image
	[CLink]
	public static extern void ImageDrawTriangleLines(Image *dst, Vector2 v1, Vector2 v2, Vector2 v3, Color32 color);
	
	/// Draw a triangle fan defined by points within an image (first vertex is the center)
	[CLink]
	public static extern void ImageDrawTriangleFan(Image *dst, Vector2 *points, int32 pointCount, Color32 color);
	
	/// Draw a triangle strip defined by points within an image
	[CLink]
	public static extern void ImageDrawTriangleStrip(Image *dst, Vector2 *points, int32 pointCount, Color32 color);
	
	/// Draw a source image within a destination image (tint applied to source)
	[CLink]
	public static extern void ImageDraw(Image *dst, Image src, Rectangle srcRec, Rectangle dstRec, Color32 tint);
	
	/// Draw text (using default font) within an image (destination)
	[CLink]
	public static extern void ImageDrawText(Image *dst, char8 *text, int32 posX, int32 posY, int32 fontSize, Color32 color);
	
	/// Draw text (custom sprite font) within an image (destination)
	[CLink]
	public static extern void ImageDrawTextEx(Image *dst, Font font, char8 *text, Vector2 position, float fontSize, float spacing, Color32 tint);
	...
	/// Draw a Texture2D
	[CLink]
	public static extern void DrawTexture(Texture2D texture, int32 posX, int32 posY, Color32 tint);
	
	/// Draw a Texture2D with position defined as Vector2
	[CLink]
	public static extern void DrawTextureV(Texture2D texture, Vector2 position, Color32 tint);
	
	/// Draw a Texture2D with extended parameters
	[CLink]
	public static extern void DrawTextureEx(Texture2D texture, Vector2 position, float rotation, float scale, Color32 tint);
	
	/// Draw a part of a texture defined by a rectangle
	[CLink]
	public static extern void DrawTextureRec(Texture2D texture, Rectangle source, Vector2 position, Color32 tint);
	
	/// Draw a part of a texture defined by a rectangle with 'pro' parameters
	[CLink]
	public static extern void DrawTexturePro(Texture2D texture, Rectangle source, Rectangle dest, Vector2 origin, float rotation, Color32 tint);
	
	/// Draws a texture (or part of it) that stretches or shrinks nicely
	[CLink]
	public static extern void DrawTextureNPatch(Texture2D texture, NPatchInfo nPatchInfo, Rectangle dest, Vector2 origin, float rotation, Color32 tint);
	
	/// Check if two colors are equal
	[CLink]
	public static extern bool ColorIsEqual(Color32 col1, Color32 col2);
	
	/// Get color with alpha applied, alpha goes from 0.0f to 1.0f
	[CLink]
	public static extern Color32 Fade(Color32 color, float alpha);
	
	/// Get hexadecimal value for a Color (0xRRGGBBAA)
	[CLink]
	public static extern int32 ColorToInt(Color32 color);
	
	/// Get Color normalized as float [0..1]
	[CLink]
	public static extern Vector4 ColorNormalize(Color32 color);
	
	/// Get Color from normalized values [0..1]
	[CLink]
	public static extern Color32 ColorFromNormalized(Vector4 normalized);
	
	/// Get HSV values for a Color, hue [0..360], saturation/value [0..1]
	[CLink]
	public static extern Vector3 ColorToHSV(Color32 color);
	
	/// Get color multiplied with another color
	[CLink]
	public static extern Color32 ColorTint(Color32 color, Color32 tint);
	
	/// Get color with brightness correction, brightness factor goes from -1.0f to 1.0f
	[CLink]
	public static extern Color32 ColorBrightness(Color32 color, float factor);
	
	/// Get color with contrast correction, contrast values between -1.0f and 1.0f
	[CLink]
	public static extern Color32 ColorContrast(Color32 color, float contrast);
	
	/// Get color with alpha applied, alpha goes from 0.0f to 1.0f
	[CLink]
	public static extern Color32 ColorAlpha(Color32 color, float alpha);
	
	/// Get src alpha-blended into dst color with tint
	[CLink]
	public static extern Color32 ColorAlphaBlend(Color32 dst, Color32 src, Color32 tint);
	
	/// Get color lerp interpolation between two colors, factor [0.0f..1.0f]
	[CLink]
	public static extern Color32 ColorLerp(Color32 color1, Color32 color2, float factor);
	
	/// Set color formatted into destination pixel pointer
	[CLink]
	public static extern void SetPixelColor(void *dstPtr, Color32 color, int32 format);
	
	/// Load font from Image (XNA style)
	[CLink]
	public static extern Font LoadFontFromImage(Image image, Color32 key, int32 firstChar);
	...
	[CLink]
	public static extern void DrawText(char8 *text, int32 posX, int32 posY, int32 fontSize, Color32 color);
	
	/// Draw text using font and additional parameters
	[CLink]
	public static extern void DrawTextEx(Font font, char8 *text, Vector2 position, float fontSize, float spacing, Color32 tint);
	
	/// Draw text using Font and pro parameters (rotation)
	[CLink]
	public static extern void DrawTextPro(Font font, char8 *text, Vector2 position, Vector2 origin, float rotation, float fontSize, float spacing, Color32 tint);
	
	/// Draw one character (codepoint)
	[CLink]
	public static extern void DrawTextCodepoint(Font font, int32 codepoint, Vector2 position, float fontSize, Color32 tint);
	
	/// Draw multiple character (codepoint)
	[CLink]
	public static extern void DrawTextCodepoints(Font font, int32 *codepoints, int32 codepointCount, Vector2 position, float fontSize, float spacing, Color32 tint);
	...
	[CLink]
	public static extern void DrawLine3D(Vector3 startPos, Vector3 endPos, Color32 color);
	
	/// Draw a point in 3D space, actually a small line
	[CLink]
	public static extern void DrawPoint3D(Vector3 position, Color32 color);
	
	/// Draw a circle in 3D world space
	[CLink]
	public static extern void DrawCircle3D(Vector3 center, float radius, Vector3 rotationAxis, float rotationAngle, Color32 color);
	
	/// Draw a color-filled triangle (vertex in counter-clockwise order!)
	[CLink]
	public static extern void DrawTriangle3D(Vector3 v1, Vector3 v2, Vector3 v3, Color32 color);
	
	/// Draw a triangle strip defined by points
	[CLink]
	public static extern void DrawTriangleStrip3D(Vector3 *points, int32 pointCount, Color32 color);
	
	/// Draw cube
	[CLink]
	public static extern void DrawCube(Vector3 position, float width, float height, float length, Color32 color);
	
	/// Draw cube (Vector version)
	[CLink]
	public static extern void DrawCubeV(Vector3 position, Vector3 size, Color32 color);
	
	/// Draw cube wires
	[CLink]
	public static extern void DrawCubeWires(Vector3 position, float width, float height, float length, Color32 color);
	
	/// Draw cube wires (Vector version)
	[CLink]
	public static extern void DrawCubeWiresV(Vector3 position, Vector3 size, Color32 color);
	
	/// Draw sphere
	[CLink]
	public static extern void DrawSphere(Vector3 centerPos, float radius, Color32 color);
	
	/// Draw sphere with extended parameters
	[CLink]
	public static extern void DrawSphereEx(Vector3 centerPos, float radius, int32 rings, int32 slices, Color32 color);
	
	/// Draw sphere wires
	[CLink]
	public static extern void DrawSphereWires(Vector3 centerPos, float radius, int32 rings, int32 slices, Color32 color);
	
	/// Draw a cylinder/cone
	[CLink]
	public static extern void DrawCylinder(Vector3 position, float radiusTop, float radiusBottom, float height, int32 slices, Color32 color);
	
	/// Draw a cylinder with base at startPos and top at endPos
	[CLink]
	public static extern void DrawCylinderEx(Vector3 startPos, Vector3 endPos, float startRadius, float endRadius, int32 sides, Color32 color);
	
	/// Draw a cylinder/cone wires
	[CLink]
	public static extern void DrawCylinderWires(Vector3 position, float radiusTop, float radiusBottom, float height, int32 slices, Color32 color);
	
	/// Draw a cylinder wires with base at startPos and top at endPos
	[CLink]
	public static extern void DrawCylinderWiresEx(Vector3 startPos, Vector3 endPos, float startRadius, float endRadius, int32 sides, Color32 color);
	
	/// Draw a capsule with the center of its sphere caps at startPos and endPos
	[CLink]
	public static extern void DrawCapsule(Vector3 startPos, Vector3 endPos, float radius, int32 slices, int32 rings, Color32 color);
	
	/// Draw capsule wireframe with the center of its sphere caps at startPos and endPos
	[CLink]
	public static extern void DrawCapsuleWires(Vector3 startPos, Vector3 endPos, float radius, int32 slices, int32 rings, Color32 color);
	
	/// Draw a plane XZ
	[CLink]
	public static extern void DrawPlane(Vector3 centerPos, Vector2 size, Color32 color);
	
	/// Draw a ray line
	[CLink]
	public static extern void DrawRay(Ray ray, Color32 color);
	...
	[CLink]
	public static extern void DrawModel(Model model, Vector3 position, float scale, Color32 tint);
	
	/// Draw a model with extended parameters
	[CLink]
	public static extern void DrawModelEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color32 tint);
	
	/// Draw a model wires (with texture if set)
	[CLink]
	public static extern void DrawModelWires(Model model, Vector3 position, float scale, Color32 tint);
	
	/// Draw a model wires (with texture if set) with extended parameters
	[CLink]
	public static extern void DrawModelWiresEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color32 tint);
	
	/// Draw a model as points
	[CLink]
	public static extern void DrawModelPoints(Model model, Vector3 position, float scale, Color32 tint);
	
	/// Draw a model as points with extended parameters
	[CLink]
	public static extern void DrawModelPointsEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color32 tint);
	
	/// Draw bounding box (wires)
	[CLink]
	public static extern void DrawBoundingBox(BoundingBox @box, Color32 color);
	
	/// Draw a billboard texture
	[CLink]
	public static extern void DrawBillboard(Camera camera, Texture2D texture, Vector3 position, float scale, Color32 tint);
	
	/// Draw a billboard texture defined by source
	[CLink]
	public static extern void DrawBillboardRec(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector2 size, Color32 tint);
	
	/// Draw a billboard texture defined by source and rotation
	[CLink]
	public static extern void DrawBillboardPro(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, Color32 tint);
	...
	/// Set background color (framebuffer clear color)
	[Inline]
	public static void ClearBackground(Color32 color)
	{
		ClearBackground_Impl(color);
	}
	[LinkName("ClearBackground")]
	private static extern void ClearBackground_Impl(in Color32 color);
	...
	/// Draw a pixel using geometry [Can be slow, use with care]
	[Inline]
	public static void DrawPixel(int32 posX, int32 posY, Color32 color)
	{
		DrawPixel_Impl(posX, posY, color);
	}
	[LinkName("DrawPixel")]
	private static extern void DrawPixel_Impl(int32 posX, int32 posY, in Color32 color);
	
	/// Draw a pixel using geometry (Vector version) [Can be slow, use with care]
	[Inline]
	public static void DrawPixelV(Vector2 position, Color32 color)
	{
		DrawPixelV_Impl(position, color);
	}
	[LinkName("DrawPixelV")]
	private static extern void DrawPixelV_Impl(in Vector2 position, in Color32 color);
	
	/// Draw a line
	[Inline]
	public static void DrawLine(int32 startPosX, int32 startPosY, int32 endPosX, int32 endPosY, Color32 color)
	{
		DrawLine_Impl(startPosX, startPosY, endPosX, endPosY, color);
	}
	[LinkName("DrawLine")]
	private static extern void DrawLine_Impl(int32 startPosX, int32 startPosY, int32 endPosX, int32 endPosY, in Color32 color);
	
	/// Draw a line (using gl lines)
	[Inline]
	public static void DrawLineV(Vector2 startPos, Vector2 endPos, Color32 color)
	{
		DrawLineV_Impl(startPos, endPos, color);
	}
	[LinkName("DrawLineV")]
	private static extern void DrawLineV_Impl(in Vector2 startPos, in Vector2 endPos, in Color32 color);
	
	/// Draw a line (using triangles/quads)
	[Inline]
	public static void DrawLineEx(Vector2 startPos, Vector2 endPos, float thick, Color32 color)
	{
		DrawLineEx_Impl(startPos, endPos, thick, color);
	}
	[LinkName("DrawLineEx")]
	private static extern void DrawLineEx_Impl(in Vector2 startPos, in Vector2 endPos, float thick, in Color32 color);
	
	/// Draw lines sequence (using gl lines)
	[Inline]
	public static void DrawLineStrip(Vector2 *points, int32 pointCount, Color32 color)
	{
		DrawLineStrip_Impl(points, pointCount, color);
	}
	[LinkName("DrawLineStrip")]
	private static extern void DrawLineStrip_Impl(Vector2 *points, int32 pointCount, in Color32 color);
	
	/// Draw line segment cubic-bezier in-out interpolation
	[Inline]
	public static void DrawLineBezier(Vector2 startPos, Vector2 endPos, float thick, Color32 color)
	{
		DrawLineBezier_Impl(startPos, endPos, thick, color);
	}
	[LinkName("DrawLineBezier")]
	private static extern void DrawLineBezier_Impl(in Vector2 startPos, in Vector2 endPos, float thick, in Color32 color);
	
	/// Draw a color-filled circle
	[Inline]
	public static void DrawCircle(int32 centerX, int32 centerY, float radius, Color32 color)
	{
		DrawCircle_Impl(centerX, centerY, radius, color);
	}
	[LinkName("DrawCircle")]
	private static extern void DrawCircle_Impl(int32 centerX, int32 centerY, float radius, in Color32 color);
	
	/// Draw a piece of a circle
	[Inline]
	public static void DrawCircleSector(Vector2 center, float radius, float startAngle, float endAngle, int32 segments, Color32 color)
	{
		DrawCircleSector_Impl(center, radius, startAngle, endAngle, segments, color);
	}
	[LinkName("DrawCircleSector")]
	private static extern void DrawCircleSector_Impl(in Vector2 center, float radius, float startAngle, float endAngle, int32 segments, in Color32 color);
	
	/// Draw circle sector outline
	[Inline]
	public static void DrawCircleSectorLines(Vector2 center, float radius, float startAngle, float endAngle, int32 segments, Color32 color)
	{
		DrawCircleSectorLines_Impl(center, radius, startAngle, endAngle, segments, color);
	}
	[LinkName("DrawCircleSectorLines")]
	private static extern void DrawCircleSectorLines_Impl(in Vector2 center, float radius, float startAngle, float endAngle, int32 segments, in Color32 color);
	
	/// Draw a gradient-filled circle
	[Inline]
	public static void DrawCircleGradient(int32 centerX, int32 centerY, float radius, Color32 inner, Color32 outer)
	{
		DrawCircleGradient_Impl(centerX, centerY, radius, inner, outer);
	}
	[LinkName("DrawCircleGradient")]
	private static extern void DrawCircleGradient_Impl(int32 centerX, int32 centerY, float radius, in Color32 inner, in Color32 outer);
	
	/// Draw a color-filled circle (Vector version)
	[Inline]
	public static void DrawCircleV(Vector2 center, float radius, Color32 color)
	{
		DrawCircleV_Impl(center, radius, color);
	}
	[LinkName("DrawCircleV")]
	private static extern void DrawCircleV_Impl(in Vector2 center, float radius, in Color32 color);
	
	/// Draw circle outline
	[Inline]
	public static void DrawCircleLines(int32 centerX, int32 centerY, float radius, Color32 color)
	{
		DrawCircleLines_Impl(centerX, centerY, radius, color);
	}
	[LinkName("DrawCircleLines")]
	private static extern void DrawCircleLines_Impl(int32 centerX, int32 centerY, float radius, in Color32 color);
	
	/// Draw circle outline (Vector version)
	[Inline]
	public static void DrawCircleLinesV(Vector2 center, float radius, Color32 color)
	{
		DrawCircleLinesV_Impl(center, radius, color);
	}
	[LinkName("DrawCircleLinesV")]
	private static extern void DrawCircleLinesV_Impl(in Vector2 center, float radius, in Color32 color);
	
	/// Draw ellipse
	[Inline]
	public static void DrawEllipse(int32 centerX, int32 centerY, float radiusH, float radiusV, Color32 color)
	{
		DrawEllipse_Impl(centerX, centerY, radiusH, radiusV, color);
	}
	[LinkName("DrawEllipse")]
	private static extern void DrawEllipse_Impl(int32 centerX, int32 centerY, float radiusH, float radiusV, in Color32 color);
	
	/// Draw ellipse outline
	[Inline]
	public static void DrawEllipseLines(int32 centerX, int32 centerY, float radiusH, float radiusV, Color32 color)
	{
		DrawEllipseLines_Impl(centerX, centerY, radiusH, radiusV, color);
	}
	[LinkName("DrawEllipseLines")]
	private static extern void DrawEllipseLines_Impl(int32 centerX, int32 centerY, float radiusH, float radiusV, in Color32 color);
	
	/// Draw ring
	[Inline]
	public static void DrawRing(Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int32 segments, Color32 color)
	{
		DrawRing_Impl(center, innerRadius, outerRadius, startAngle, endAngle, segments, color);
	}
	[LinkName("DrawRing")]
	private static extern void DrawRing_Impl(in Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int32 segments, in Color32 color);
	
	/// Draw ring outline
	[Inline]
	public static void DrawRingLines(Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int32 segments, Color32 color)
	{
		DrawRingLines_Impl(center, innerRadius, outerRadius, startAngle, endAngle, segments, color);
	}
	[LinkName("DrawRingLines")]
	private static extern void DrawRingLines_Impl(in Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle, int32 segments, in Color32 color);
	
	/// Draw a color-filled rectangle
	[Inline]
	public static void DrawRectangle(int32 posX, int32 posY, int32 width, int32 height, Color32 color)
	{
		DrawRectangle_Impl(posX, posY, width, height, color);
	}
	[LinkName("DrawRectangle")]
	private static extern void DrawRectangle_Impl(int32 posX, int32 posY, int32 width, int32 height, in Color32 color);
	
	/// Draw a color-filled rectangle (Vector version)
	[Inline]
	public static void DrawRectangleV(Vector2 position, Vector2 size, Color32 color)
	{
		DrawRectangleV_Impl(position, size, color);
	}
	[LinkName("DrawRectangleV")]
	private static extern void DrawRectangleV_Impl(in Vector2 position, in Vector2 size, in Color32 color);
	
	/// Draw a color-filled rectangle
	[Inline]
	public static void DrawRectangleRec(Rectangle rec, Color32 color)
	{
		DrawRectangleRec_Impl(rec, color);
	}
	[LinkName("DrawRectangleRec")]
	private static extern void DrawRectangleRec_Impl(in Rectangle rec, in Color32 color);
	
	/// Draw a color-filled rectangle with pro parameters
	[Inline]
	public static void DrawRectanglePro(Rectangle rec, Vector2 origin, float rotation, Color32 color)
	{
		DrawRectanglePro_Impl(rec, origin, rotation, color);
	}
	[LinkName("DrawRectanglePro")]
	private static extern void DrawRectanglePro_Impl(in Rectangle rec, in Vector2 origin, float rotation, in Color32 color);
	
	/// Draw a vertical-gradient-filled rectangle
	[Inline]
	public static void DrawRectangleGradientV(int32 posX, int32 posY, int32 width, int32 height, Color32 top, Color32 bottom)
	{
		DrawRectangleGradientV_Impl(posX, posY, width, height, top, bottom);
	}
	[LinkName("DrawRectangleGradientV")]
	private static extern void DrawRectangleGradientV_Impl(int32 posX, int32 posY, int32 width, int32 height, in Color32 top, in Color32 bottom);
	
	/// Draw a horizontal-gradient-filled rectangle
	[Inline]
	public static void DrawRectangleGradientH(int32 posX, int32 posY, int32 width, int32 height, Color32 left, Color32 right)
	{
		DrawRectangleGradientH_Impl(posX, posY, width, height, left, right);
	}
	[LinkName("DrawRectangleGradientH")]
	private static extern void DrawRectangleGradientH_Impl(int32 posX, int32 posY, int32 width, int32 height, in Color32 left, in Color32 right);
	
	/// Draw a gradient-filled rectangle with custom vertex colors
	[Inline]
	public static void DrawRectangleGradientEx(Rectangle rec, Color32 topLeft, Color32 bottomLeft, Color32 topRight, Color32 bottomRight)
	{
		DrawRectangleGradientEx_Impl(rec, topLeft, bottomLeft, topRight, bottomRight);
	}
	[LinkName("DrawRectangleGradientEx")]
	private static extern void DrawRectangleGradientEx_Impl(in Rectangle rec, in Color32 topLeft, in Color32 bottomLeft, in Color32 topRight, in Color32 bottomRight);
	
	/// Draw rectangle outline
	[Inline]
	public static void DrawRectangleLines(int32 posX, int32 posY, int32 width, int32 height, Color32 color)
	{
		DrawRectangleLines_Impl(posX, posY, width, height, color);
	}
	[LinkName("DrawRectangleLines")]
	private static extern void DrawRectangleLines_Impl(int32 posX, int32 posY, int32 width, int32 height, in Color32 color);
	
	/// Draw rectangle outline with extended parameters
	[Inline]
	public static void DrawRectangleLinesEx(Rectangle rec, float lineThick, Color32 color)
	{
		DrawRectangleLinesEx_Impl(rec, lineThick, color);
	}
	[LinkName("DrawRectangleLinesEx")]
	private static extern void DrawRectangleLinesEx_Impl(in Rectangle rec, float lineThick, in Color32 color);
	
	/// Draw rectangle with rounded edges
	[Inline]
	public static void DrawRectangleRounded(Rectangle rec, float roundness, int32 segments, Color32 color)
	{
		DrawRectangleRounded_Impl(rec, roundness, segments, color);
	}
	[LinkName("DrawRectangleRounded")]
	private static extern void DrawRectangleRounded_Impl(in Rectangle rec, float roundness, int32 segments, in Color32 color);
	
	/// Draw rectangle lines with rounded edges
	[Inline]
	public static void DrawRectangleRoundedLines(Rectangle rec, float roundness, int32 segments, Color32 color)
	{
		DrawRectangleRoundedLines_Impl(rec, roundness, segments, color);
	}
	[LinkName("DrawRectangleRoundedLines")]
	private static extern void DrawRectangleRoundedLines_Impl(in Rectangle rec, float roundness, int32 segments, in Color32 color);
	
	/// Draw rectangle with rounded edges outline
	[Inline]
	public static void DrawRectangleRoundedLinesEx(Rectangle rec, float roundness, int32 segments, float lineThick, Color32 color)
	{
		DrawRectangleRoundedLinesEx_Impl(rec, roundness, segments, lineThick, color);
	}
	[LinkName("DrawRectangleRoundedLinesEx")]
	private static extern void DrawRectangleRoundedLinesEx_Impl(in Rectangle rec, float roundness, int32 segments, float lineThick, in Color32 color);
	
	/// Draw a color-filled triangle (vertex in counter-clockwise order!)
	[Inline]
	public static void DrawTriangle(Vector2 v1, Vector2 v2, Vector2 v3, Color32 color)
	{
		DrawTriangle_Impl(v1, v2, v3, color);
	}
	[LinkName("DrawTriangle")]
	private static extern void DrawTriangle_Impl(in Vector2 v1, in Vector2 v2, in Vector2 v3, in Color32 color);
	
	/// Draw triangle outline (vertex in counter-clockwise order!)
	[Inline]
	public static void DrawTriangleLines(Vector2 v1, Vector2 v2, Vector2 v3, Color32 color)
	{
		DrawTriangleLines_Impl(v1, v2, v3, color);
	}
	[LinkName("DrawTriangleLines")]
	private static extern void DrawTriangleLines_Impl(in Vector2 v1, in Vector2 v2, in Vector2 v3, in Color32 color);
	
	/// Draw a triangle fan defined by points (first vertex is the center)
	[Inline]
	public static void DrawTriangleFan(Vector2 *points, int32 pointCount, Color32 color)
	{
		DrawTriangleFan_Impl(points, pointCount, color);
	}
	[LinkName("DrawTriangleFan")]
	private static extern void DrawTriangleFan_Impl(Vector2 *points, int32 pointCount, in Color32 color);
	
	/// Draw a triangle strip defined by points
	[Inline]
	public static void DrawTriangleStrip(Vector2 *points, int32 pointCount, Color32 color)
	{
		DrawTriangleStrip_Impl(points, pointCount, color);
	}
	[LinkName("DrawTriangleStrip")]
	private static extern void DrawTriangleStrip_Impl(Vector2 *points, int32 pointCount, in Color32 color);
	
	/// Draw a regular polygon (Vector version)
	[Inline]
	public static void DrawPoly(Vector2 center, int32 sides, float radius, float rotation, Color32 color)
	{
		DrawPoly_Impl(center, sides, radius, rotation, color);
	}
	[LinkName("DrawPoly")]
	private static extern void DrawPoly_Impl(in Vector2 center, int32 sides, float radius, float rotation, in Color32 color);
	
	/// Draw a polygon outline of n sides
	[Inline]
	public static void DrawPolyLines(Vector2 center, int32 sides, float radius, float rotation, Color32 color)
	{
		DrawPolyLines_Impl(center, sides, radius, rotation, color);
	}
	[LinkName("DrawPolyLines")]
	private static extern void DrawPolyLines_Impl(in Vector2 center, int32 sides, float radius, float rotation, in Color32 color);
	
	/// Draw a polygon outline of n sides with extended parameters
	[Inline]
	public static void DrawPolyLinesEx(Vector2 center, int32 sides, float radius, float rotation, float lineThick, Color32 color)
	{
		DrawPolyLinesEx_Impl(center, sides, radius, rotation, lineThick, color);
	}
	[LinkName("DrawPolyLinesEx")]
	private static extern void DrawPolyLinesEx_Impl(in Vector2 center, int32 sides, float radius, float rotation, float lineThick, in Color32 color);
	
	/// Draw spline: Linear, minimum 2 points
	[Inline]
	public static void DrawSplineLinear(Vector2 *points, int32 pointCount, float thick, Color32 color)
	{
		DrawSplineLinear_Impl(points, pointCount, thick, color);
	}
	[LinkName("DrawSplineLinear")]
	private static extern void DrawSplineLinear_Impl(Vector2 *points, int32 pointCount, float thick, in Color32 color);
	
	/// Draw spline: B-Spline, minimum 4 points
	[Inline]
	public static void DrawSplineBasis(Vector2 *points, int32 pointCount, float thick, Color32 color)
	{
		DrawSplineBasis_Impl(points, pointCount, thick, color);
	}
	[LinkName("DrawSplineBasis")]
	private static extern void DrawSplineBasis_Impl(Vector2 *points, int32 pointCount, float thick, in Color32 color);
	
	/// Draw spline: Catmull-Rom, minimum 4 points
	[Inline]
	public static void DrawSplineCatmullRom(Vector2 *points, int32 pointCount, float thick, Color32 color)
	{
		DrawSplineCatmullRom_Impl(points, pointCount, thick, color);
	}
	[LinkName("DrawSplineCatmullRom")]
	private static extern void DrawSplineCatmullRom_Impl(Vector2 *points, int32 pointCount, float thick, in Color32 color);
	
	/// Draw spline: Quadratic Bezier, minimum 3 points (1 control point): [p1, c2, p3, c4...]
	[Inline]
	public static void DrawSplineBezierQuadratic(Vector2 *points, int32 pointCount, float thick, Color32 color)
	{
		DrawSplineBezierQuadratic_Impl(points, pointCount, thick, color);
	}
	[LinkName("DrawSplineBezierQuadratic")]
	private static extern void DrawSplineBezierQuadratic_Impl(Vector2 *points, int32 pointCount, float thick, in Color32 color);
	
	/// Draw spline: Cubic Bezier, minimum 4 points (2 control points): [p1, c2, c3, p4, c5, c6...]
	[Inline]
	public static void DrawSplineBezierCubic(Vector2 *points, int32 pointCount, float thick, Color32 color)
	{
		DrawSplineBezierCubic_Impl(points, pointCount, thick, color);
	}
	[LinkName("DrawSplineBezierCubic")]
	private static extern void DrawSplineBezierCubic_Impl(Vector2 *points, int32 pointCount, float thick, in Color32 color);
	
	/// Draw spline segment: Linear, 2 points
	[Inline]
	public static void DrawSplineSegmentLinear(Vector2 p1, Vector2 p2, float thick, Color32 color)
	{
		DrawSplineSegmentLinear_Impl(p1, p2, thick, color);
	}
	[LinkName("DrawSplineSegmentLinear")]
	private static extern void DrawSplineSegmentLinear_Impl(in Vector2 p1, in Vector2 p2, float thick, in Color32 color);
	
	/// Draw spline segment: B-Spline, 4 points
	[Inline]
	public static void DrawSplineSegmentBasis(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float thick, Color32 color)
	{
		DrawSplineSegmentBasis_Impl(p1, p2, p3, p4, thick, color);
	}
	[LinkName("DrawSplineSegmentBasis")]
	private static extern void DrawSplineSegmentBasis_Impl(in Vector2 p1, in Vector2 p2, in Vector2 p3, in Vector2 p4, float thick, in Color32 color);
	
	/// Draw spline segment: Catmull-Rom, 4 points
	[Inline]
	public static void DrawSplineSegmentCatmullRom(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float thick, Color32 color)
	{
		DrawSplineSegmentCatmullRom_Impl(p1, p2, p3, p4, thick, color);
	}
	[LinkName("DrawSplineSegmentCatmullRom")]
	private static extern void DrawSplineSegmentCatmullRom_Impl(in Vector2 p1, in Vector2 p2, in Vector2 p3, in Vector2 p4, float thick, in Color32 color);
	
	/// Draw spline segment: Quadratic Bezier, 2 points, 1 control point
	[Inline]
	public static void DrawSplineSegmentBezierQuadratic(Vector2 p1, Vector2 c2, Vector2 p3, float thick, Color32 color)
	{
		DrawSplineSegmentBezierQuadratic_Impl(p1, c2, p3, thick, color);
	}
	[LinkName("DrawSplineSegmentBezierQuadratic")]
	private static extern void DrawSplineSegmentBezierQuadratic_Impl(in Vector2 p1, in Vector2 c2, in Vector2 p3, float thick, in Color32 color);
	
	/// Draw spline segment: Cubic Bezier, 2 points, 2 control points
	[Inline]
	public static void DrawSplineSegmentBezierCubic(Vector2 p1, Vector2 c2, Vector2 c3, Vector2 p4, float thick, Color32 color)
	{
		DrawSplineSegmentBezierCubic_Impl(p1, c2, c3, p4, thick, color);
	}
	[LinkName("DrawSplineSegmentBezierCubic")]
	private static extern void DrawSplineSegmentBezierCubic_Impl(in Vector2 p1, in Vector2 c2, in Vector2 c3, in Vector2 p4, float thick, in Color32 color);
	...
	/// Generate image: plain color
	[Inline]
	public static Image GenImageColor(int32 width, int32 height, Color32 color)
	{
		return GenImageColor_Impl(width, height, color);
	}
	[LinkName("GenImageColor")]
	private static extern Image GenImageColor_Impl(int32 width, int32 height, in Color32 color);
	
	/// Generate image: linear gradient, direction in degrees [0..360], 0=Vertical gradient
	[Inline]
	public static Image GenImageGradientLinear(int32 width, int32 height, int32 direction, Color32 start, Color32 end)
	{
		return GenImageGradientLinear_Impl(width, height, direction, start, end);
	}
	[LinkName("GenImageGradientLinear")]
	private static extern Image GenImageGradientLinear_Impl(int32 width, int32 height, int32 direction, in Color32 start, in Color32 end);
	
	/// Generate image: radial gradient
	[Inline]
	public static Image GenImageGradientRadial(int32 width, int32 height, float density, Color32 inner, Color32 outer)
	{
		return GenImageGradientRadial_Impl(width, height, density, inner, outer);
	}
	[LinkName("GenImageGradientRadial")]
	private static extern Image GenImageGradientRadial_Impl(int32 width, int32 height, float density, in Color32 inner, in Color32 outer);
	
	/// Generate image: square gradient
	[Inline]
	public static Image GenImageGradientSquare(int32 width, int32 height, float density, Color32 inner, Color32 outer)
	{
		return GenImageGradientSquare_Impl(width, height, density, inner, outer);
	}
	[LinkName("GenImageGradientSquare")]
	private static extern Image GenImageGradientSquare_Impl(int32 width, int32 height, float density, in Color32 inner, in Color32 outer);
	
	/// Generate image: checked
	[Inline]
	public static Image GenImageChecked(int32 width, int32 height, int32 checksX, int32 checksY, Color32 col1, Color32 col2)
	{
		return GenImageChecked_Impl(width, height, checksX, checksY, col1, col2);
	}
	[LinkName("GenImageChecked")]
	private static extern Image GenImageChecked_Impl(int32 width, int32 height, int32 checksX, int32 checksY, in Color32 col1, in Color32 col2);
	...
	/// Create an image from text (default font)
	[Inline]
	public static Image ImageText(char8 *text, int32 fontSize, Color32 color)
	{
		return ImageText_Impl(text, fontSize, color);
	}
	[LinkName("ImageText")]
	private static extern Image ImageText_Impl(char8 *text, int32 fontSize, in Color32 color);
	
	/// Create an image from text (custom sprite font)
	[Inline]
	public static Image ImageTextEx(Font font, char8 *text, float fontSize, float spacing, Color32 tint)
	{
		return ImageTextEx_Impl(font, text, fontSize, spacing, tint);
	}
	[LinkName("ImageTextEx")]
	private static extern Image ImageTextEx_Impl(in Font font, char8 *text, float fontSize, float spacing, in Color32 tint);
	
	/// Convert image to POT (power-of-two)
	[Inline]
	public static void ImageToPOT(Image *image, Color32 fill)
	{
		ImageToPOT_Impl(image, fill);
	}
	[LinkName("ImageToPOT")]
	private static extern void ImageToPOT_Impl(Image *image, in Color32 fill);
	...
	/// Clear alpha channel to desired color
	[Inline]
	public static void ImageAlphaClear(Image *image, Color32 color, float threshold)
	{
		ImageAlphaClear_Impl(image, color, threshold);
	}
	[LinkName("ImageAlphaClear")]
	private static extern void ImageAlphaClear_Impl(Image *image, in Color32 color, float threshold);
	...
	/// Resize canvas and fill with color
	[Inline]
	public static void ImageResizeCanvas(Image *image, int32 newWidth, int32 newHeight, int32 offsetX, int32 offsetY, Color32 fill)
	{
		ImageResizeCanvas_Impl(image, newWidth, newHeight, offsetX, offsetY, fill);
	}
	[LinkName("ImageResizeCanvas")]
	private static extern void ImageResizeCanvas_Impl(Image *image, int32 newWidth, int32 newHeight, int32 offsetX, int32 offsetY, in Color32 fill);
	
	/// Modify image color: tint
	[Inline]
	public static void ImageColorTint(Image *image, Color32 color)
	{
		ImageColorTint_Impl(image, color);
	}
	[LinkName("ImageColorTint")]
	private static extern void ImageColorTint_Impl(Image *image, in Color32 color);
	
	/// Modify image color: replace color
	[Inline]
	public static void ImageColorReplace(Image *image, Color32 color, Color32 replace)
	{
		ImageColorReplace_Impl(image, color, replace);
	}
	[LinkName("ImageColorReplace")]
	private static extern void ImageColorReplace_Impl(Image *image, in Color32 color, in Color32 replace);
	
	/// Load color data from image as a Color array (RGBA - 32bit)
	[Inline]
	public static Color32 * LoadImageColors(Image image)
	{
		return LoadImageColors_Impl(image);
	}
	[LinkName("LoadImageColors")]
	private static extern Color32 * LoadImageColors_Impl(in Image image);
	
	/// Load colors palette from image as a Color array (RGBA - 32bit)
	[Inline]
	public static Color32 * LoadImagePalette(Image image, int32 maxPaletteSize, int32 *colorCount)
	{
		return LoadImagePalette_Impl(image, maxPaletteSize, colorCount);
	}
	[LinkName("LoadImagePalette")]
	private static extern Color32 * LoadImagePalette_Impl(in Image image, int32 maxPaletteSize, int32 *colorCount);
	...
	/// Get image pixel color at (x, y) position
	[Inline]
	public static Color32 GetImageColor(Image image, int32 x, int32 y)
	{
		return GetImageColor_Impl(image, x, y);
	}
	[LinkName("GetImageColor")]
	private static extern Color32 GetImageColor_Impl(in Image image, int32 x, int32 y);
	
	/// Clear image background with given color
	[Inline]
	public static void ImageClearBackground(Image *dst, Color32 color)
	{
		ImageClearBackground_Impl(dst, color);
	}
	[LinkName("ImageClearBackground")]
	private static extern void ImageClearBackground_Impl(Image *dst, in Color32 color);
	
	/// Draw pixel within an image
	[Inline]
	public static void ImageDrawPixel(Image *dst, int32 posX, int32 posY, Color32 color)
	{
		ImageDrawPixel_Impl(dst, posX, posY, color);
	}
	[LinkName("ImageDrawPixel")]
	private static extern void ImageDrawPixel_Impl(Image *dst, int32 posX, int32 posY, in Color32 color);
	
	/// Draw pixel within an image (Vector version)
	[Inline]
	public static void ImageDrawPixelV(Image *dst, Vector2 position, Color32 color)
	{
		ImageDrawPixelV_Impl(dst, position, color);
	}
	[LinkName("ImageDrawPixelV")]
	private static extern void ImageDrawPixelV_Impl(Image *dst, in Vector2 position, in Color32 color);
	
	/// Draw line within an image
	[Inline]
	public static void ImageDrawLine(Image *dst, int32 startPosX, int32 startPosY, int32 endPosX, int32 endPosY, Color32 color)
	{
		ImageDrawLine_Impl(dst, startPosX, startPosY, endPosX, endPosY, color);
	}
	[LinkName("ImageDrawLine")]
	private static extern void ImageDrawLine_Impl(Image *dst, int32 startPosX, int32 startPosY, int32 endPosX, int32 endPosY, in Color32 color);
	
	/// Draw line within an image (Vector version)
	[Inline]
	public static void ImageDrawLineV(Image *dst, Vector2 start, Vector2 end, Color32 color)
	{
		ImageDrawLineV_Impl(dst, start, end, color);
	}
	[LinkName("ImageDrawLineV")]
	private static extern void ImageDrawLineV_Impl(Image *dst, in Vector2 start, in Vector2 end, in Color32 color);
	
	/// Draw a line defining thickness within an image
	[Inline]
	public static void ImageDrawLineEx(Image *dst, Vector2 start, Vector2 end, int32 thick, Color32 color)
	{
		ImageDrawLineEx_Impl(dst, start, end, thick, color);
	}
	[LinkName("ImageDrawLineEx")]
	private static extern void ImageDrawLineEx_Impl(Image *dst, in Vector2 start, in Vector2 end, int32 thick, in Color32 color);
	
	/// Draw a filled circle within an image
	[Inline]
	public static void ImageDrawCircle(Image *dst, int32 centerX, int32 centerY, int32 radius, Color32 color)
	{
		ImageDrawCircle_Impl(dst, centerX, centerY, radius, color);
	}
	[LinkName("ImageDrawCircle")]
	private static extern void ImageDrawCircle_Impl(Image *dst, int32 centerX, int32 centerY, int32 radius, in Color32 color);
	
	/// Draw a filled circle within an image (Vector version)
	[Inline]
	public static void ImageDrawCircleV(Image *dst, Vector2 center, int32 radius, Color32 color)
	{
		ImageDrawCircleV_Impl(dst, center, radius, color);
	}
	[LinkName("ImageDrawCircleV")]
	private static extern void ImageDrawCircleV_Impl(Image *dst, in Vector2 center, int32 radius, in Color32 color);
	
	/// Draw circle outline within an image
	[Inline]
	public static void ImageDrawCircleLines(Image *dst, int32 centerX, int32 centerY, int32 radius, Color32 color)
	{
		ImageDrawCircleLines_Impl(dst, centerX, centerY, radius, color);
	}
	[LinkName("ImageDrawCircleLines")]
	private static extern void ImageDrawCircleLines_Impl(Image *dst, int32 centerX, int32 centerY, int32 radius, in Color32 color);
	
	/// Draw circle outline within an image (Vector version)
	[Inline]
	public static void ImageDrawCircleLinesV(Image *dst, Vector2 center, int32 radius, Color32 color)
	{
		ImageDrawCircleLinesV_Impl(dst, center, radius, color);
	}
	[LinkName("ImageDrawCircleLinesV")]
	private static extern void ImageDrawCircleLinesV_Impl(Image *dst, in Vector2 center, int32 radius, in Color32 color);
	
	/// Draw rectangle within an image
	[Inline]
	public static void ImageDrawRectangle(Image *dst, int32 posX, int32 posY, int32 width, int32 height, Color32 color)
	{
		ImageDrawRectangle_Impl(dst, posX, posY, width, height, color);
	}
	[LinkName("ImageDrawRectangle")]
	private static extern void ImageDrawRectangle_Impl(Image *dst, int32 posX, int32 posY, int32 width, int32 height, in Color32 color);
	
	/// Draw rectangle within an image (Vector version)
	[Inline]
	public static void ImageDrawRectangleV(Image *dst, Vector2 position, Vector2 size, Color32 color)
	{
		ImageDrawRectangleV_Impl(dst, position, size, color);
	}
	[LinkName("ImageDrawRectangleV")]
	private static extern void ImageDrawRectangleV_Impl(Image *dst, in Vector2 position, in Vector2 size, in Color32 color);
	
	/// Draw rectangle within an image
	[Inline]
	public static void ImageDrawRectangleRec(Image *dst, Rectangle rec, Color32 color)
	{
		ImageDrawRectangleRec_Impl(dst, rec, color);
	}
	[LinkName("ImageDrawRectangleRec")]
	private static extern void ImageDrawRectangleRec_Impl(Image *dst, in Rectangle rec, in Color32 color);
	
	/// Draw rectangle lines within an image
	[Inline]
	public static void ImageDrawRectangleLines(Image *dst, Rectangle rec, int32 thick, Color32 color)
	{
		ImageDrawRectangleLines_Impl(dst, rec, thick, color);
	}
	[LinkName("ImageDrawRectangleLines")]
	private static extern void ImageDrawRectangleLines_Impl(Image *dst, in Rectangle rec, int32 thick, in Color32 color);
	
	/// Draw triangle within an image
	[Inline]
	public static void ImageDrawTriangle(Image *dst, Vector2 v1, Vector2 v2, Vector2 v3, Color32 color)
	{
		ImageDrawTriangle_Impl(dst, v1, v2, v3, color);
	}
	[LinkName("ImageDrawTriangle")]
	private static extern void ImageDrawTriangle_Impl(Image *dst, in Vector2 v1, in Vector2 v2, in Vector2 v3, in Color32 color);
	
	/// Draw triangle with interpolated colors within an image
	[Inline]
	public static void ImageDrawTriangleEx(Image *dst, Vector2 v1, Vector2 v2, Vector2 v3, Color32 c1, Color32 c2, Color32 c3)
	{
		ImageDrawTriangleEx_Impl(dst, v1, v2, v3, c1, c2, c3);
	}
	[LinkName("ImageDrawTriangleEx")]
	private static extern void ImageDrawTriangleEx_Impl(Image *dst, in Vector2 v1, in Vector2 v2, in Vector2 v3, in Color32 c1, in Color32 c2, in Color32 c3);
	
	/// Draw triangle outline within an image
	[Inline]
	public static void ImageDrawTriangleLines(Image *dst, Vector2 v1, Vector2 v2, Vector2 v3, Color32 color)
	{
		ImageDrawTriangleLines_Impl(dst, v1, v2, v3, color);
	}
	[LinkName("ImageDrawTriangleLines")]
	private static extern void ImageDrawTriangleLines_Impl(Image *dst, in Vector2 v1, in Vector2 v2, in Vector2 v3, in Color32 color);
	
	/// Draw a triangle fan defined by points within an image (first vertex is the center)
	[Inline]
	public static void ImageDrawTriangleFan(Image *dst, Vector2 *points, int32 pointCount, Color32 color)
	{
		ImageDrawTriangleFan_Impl(dst, points, pointCount, color);
	}
	[LinkName("ImageDrawTriangleFan")]
	private static extern void ImageDrawTriangleFan_Impl(Image *dst, Vector2 *points, int32 pointCount, in Color32 color);
	
	/// Draw a triangle strip defined by points within an image
	[Inline]
	public static void ImageDrawTriangleStrip(Image *dst, Vector2 *points, int32 pointCount, Color32 color)
	{
		ImageDrawTriangleStrip_Impl(dst, points, pointCount, color);
	}
	[LinkName("ImageDrawTriangleStrip")]
	private static extern void ImageDrawTriangleStrip_Impl(Image *dst, Vector2 *points, int32 pointCount, in Color32 color);
	
	/// Draw a source image within a destination image (tint applied to source)
	[Inline]
	public static void ImageDraw(Image *dst, Image src, Rectangle srcRec, Rectangle dstRec, Color32 tint)
	{
		ImageDraw_Impl(dst, src, srcRec, dstRec, tint);
	}
	[LinkName("ImageDraw")]
	private static extern void ImageDraw_Impl(Image *dst, in Image src, in Rectangle srcRec, in Rectangle dstRec, in Color32 tint);
	
	/// Draw text (using default font) within an image (destination)
	[Inline]
	public static void ImageDrawText(Image *dst, char8 *text, int32 posX, int32 posY, int32 fontSize, Color32 color)
	{
		ImageDrawText_Impl(dst, text, posX, posY, fontSize, color);
	}
	[LinkName("ImageDrawText")]
	private static extern void ImageDrawText_Impl(Image *dst, char8 *text, int32 posX, int32 posY, int32 fontSize, in Color32 color);
	
	/// Draw text (custom sprite font) within an image (destination)
	[Inline]
	public static void ImageDrawTextEx(Image *dst, Font font, char8 *text, Vector2 position, float fontSize, float spacing, Color32 tint)
	{
		ImageDrawTextEx_Impl(dst, font, text, position, fontSize, spacing, tint);
	}
	[LinkName("ImageDrawTextEx")]
	private static extern void ImageDrawTextEx_Impl(Image *dst, in Font font, char8 *text, in Vector2 position, float fontSize, float spacing, in Color32 tint);
	...
	/// Draw a Texture2D
	[Inline]
	public static void DrawTexture(Texture2D texture, int32 posX, int32 posY, Color32 tint)
	{
		DrawTexture_Impl(texture, posX, posY, tint);
	}
	[LinkName("DrawTexture")]
	private static extern void DrawTexture_Impl(in Texture2D texture, int32 posX, int32 posY, in Color32 tint);
	
	/// Draw a Texture2D with position defined as Vector2
	[Inline]
	public static void DrawTextureV(Texture2D texture, Vector2 position, Color32 tint)
	{
		DrawTextureV_Impl(texture, position, tint);
	}
	[LinkName("DrawTextureV")]
	private static extern void DrawTextureV_Impl(in Texture2D texture, in Vector2 position, in Color32 tint);
	
	/// Draw a Texture2D with extended parameters
	[Inline]
	public static void DrawTextureEx(Texture2D texture, Vector2 position, float rotation, float scale, Color32 tint)
	{
		DrawTextureEx_Impl(texture, position, rotation, scale, tint);
	}
	[LinkName("DrawTextureEx")]
	private static extern void DrawTextureEx_Impl(in Texture2D texture, in Vector2 position, float rotation, float scale, in Color32 tint);
	
	/// Draw a part of a texture defined by a rectangle
	[Inline]
	public static void DrawTextureRec(Texture2D texture, Rectangle source, Vector2 position, Color32 tint)
	{
		DrawTextureRec_Impl(texture, source, position, tint);
	}
	[LinkName("DrawTextureRec")]
	private static extern void DrawTextureRec_Impl(in Texture2D texture, in Rectangle source, in Vector2 position, in Color32 tint);
	
	/// Draw a part of a texture defined by a rectangle with 'pro' parameters
	[Inline]
	public static void DrawTexturePro(Texture2D texture, Rectangle source, Rectangle dest, Vector2 origin, float rotation, Color32 tint)
	{
		DrawTexturePro_Impl(texture, source, dest, origin, rotation, tint);
	}
	[LinkName("DrawTexturePro")]
	private static extern void DrawTexturePro_Impl(in Texture2D texture, in Rectangle source, in Rectangle dest, in Vector2 origin, float rotation, in Color32 tint);
	
	/// Draws a texture (or part of it) that stretches or shrinks nicely
	[Inline]
	public static void DrawTextureNPatch(Texture2D texture, NPatchInfo nPatchInfo, Rectangle dest, Vector2 origin, float rotation, Color32 tint)
	{
		DrawTextureNPatch_Impl(texture, nPatchInfo, dest, origin, rotation, tint);
	}
	[LinkName("DrawTextureNPatch")]
	private static extern void DrawTextureNPatch_Impl(in Texture2D texture, in NPatchInfo nPatchInfo, in Rectangle dest, in Vector2 origin, float rotation, in Color32 tint);
	
	/// Check if two colors are equal
	[Inline]
	public static bool ColorIsEqual(Color32 col1, Color32 col2)
	{
		return ColorIsEqual_Impl(col1, col2);
	}
	[LinkName("ColorIsEqual")]
	private static extern bool ColorIsEqual_Impl(in Color32 col1, in Color32 col2);
	
	/// Get color with alpha applied, alpha goes from 0.0f to 1.0f
	[Inline]
	public static Color32 Fade(Color32 color, float alpha)
	{
		return Fade_Impl(color, alpha);
	}
	[LinkName("Fade")]
	private static extern Color32 Fade_Impl(in Color32 color, float alpha);
	
	/// Get hexadecimal value for a Color (0xRRGGBBAA)
	[Inline]
	public static int32 ColorToInt(Color32 color)
	{
		return ColorToInt_Impl(color);
	}
	[LinkName("ColorToInt")]
	private static extern int32 ColorToInt_Impl(in Color32 color);
	
	/// Get Color normalized as float [0..1]
	[Inline]
	public static Vector4 ColorNormalize(Color32 color)
	{
		return ColorNormalize_Impl(color);
	}
	[LinkName("ColorNormalize")]
	private static extern Vector4 ColorNormalize_Impl(in Color32 color);
	
	/// Get Color from normalized values [0..1]
	[Inline]
	public static Color32 ColorFromNormalized(Vector4 normalized)
	{
		return ColorFromNormalized_Impl(normalized);
	}
	[LinkName("ColorFromNormalized")]
	private static extern Color32 ColorFromNormalized_Impl(in Vector4 normalized);
	
	/// Get HSV values for a Color, hue [0..360], saturation/value [0..1]
	[Inline]
	public static Vector3 ColorToHSV(Color32 color)
	{
		return ColorToHSV_Impl(color);
	}
	[LinkName("ColorToHSV")]
	private static extern Vector3 ColorToHSV_Impl(in Color32 color);
	
	/// Get color multiplied with another color
	[Inline]
	public static Color32 ColorTint(Color32 color, Color32 tint)
	{
		return ColorTint_Impl(color, tint);
	}
	[LinkName("ColorTint")]
	private static extern Color32 ColorTint_Impl(in Color32 color, in Color32 tint);
	
	/// Get color with brightness correction, brightness factor goes from -1.0f to 1.0f
	[Inline]
	public static Color32 ColorBrightness(Color32 color, float factor)
	{
		return ColorBrightness_Impl(color, factor);
	}
	[LinkName("ColorBrightness")]
	private static extern Color32 ColorBrightness_Impl(in Color32 color, float factor);
	
	/// Get color with contrast correction, contrast values between -1.0f and 1.0f
	[Inline]
	public static Color32 ColorContrast(Color32 color, float contrast)
	{
		return ColorContrast_Impl(color, contrast);
	}
	[LinkName("ColorContrast")]
	private static extern Color32 ColorContrast_Impl(in Color32 color, float contrast);
	
	/// Get color with alpha applied, alpha goes from 0.0f to 1.0f
	[Inline]
	public static Color32 ColorAlpha(Color32 color, float alpha)
	{
		return ColorAlpha_Impl(color, alpha);
	}
	[LinkName("ColorAlpha")]
	private static extern Color32 ColorAlpha_Impl(in Color32 color, float alpha);
	
	/// Get src alpha-blended into dst color with tint
	[Inline]
	public static Color32 ColorAlphaBlend(Color32 dst, Color32 src, Color32 tint)
	{
		return ColorAlphaBlend_Impl(dst, src, tint);
	}
	[LinkName("ColorAlphaBlend")]
	private static extern Color32 ColorAlphaBlend_Impl(in Color32 dst, in Color32 src, in Color32 tint);
	
	/// Get color lerp interpolation between two colors, factor [0.0f..1.0f]
	[Inline]
	public static Color32 ColorLerp(Color32 color1, Color32 color2, float factor)
	{
		return ColorLerp_Impl(color1, color2, factor);
	}
	[LinkName("ColorLerp")]
	private static extern Color32 ColorLerp_Impl(in Color32 color1, in Color32 color2, float factor);
	
	/// Set color formatted into destination pixel pointer
	[Inline]
	public static void SetPixelColor(void *dstPtr, Color32 color, int32 format)
	{
		SetPixelColor_Impl(dstPtr, color, format);
	}
	[LinkName("SetPixelColor")]
	private static extern void SetPixelColor_Impl(void *dstPtr, in Color32 color, int32 format);
	
	/// Load font from Image (XNA style)
	[Inline]
	public static Font LoadFontFromImage(Image image, Color32 key, int32 firstChar)
	{
		return LoadFontFromImage_Impl(image, key, firstChar);
	}
	[LinkName("LoadFontFromImage")]
	private static extern Font LoadFontFromImage_Impl(in Image image, in Color32 key, int32 firstChar);
	...
	/// Draw text (using default font)
	[Inline]
	public static void DrawText(char8 *text, int32 posX, int32 posY, int32 fontSize, Color32 color)
	{
		DrawText_Impl(text, posX, posY, fontSize, color);
	}
	[LinkName("DrawText")]
	private static extern void DrawText_Impl(char8 *text, int32 posX, int32 posY, int32 fontSize, in Color32 color);
	
	/// Draw text using font and additional parameters
	[Inline]
	public static void DrawTextEx(Font font, char8 *text, Vector2 position, float fontSize, float spacing, Color32 tint)
	{
		DrawTextEx_Impl(font, text, position, fontSize, spacing, tint);
	}
	[LinkName("DrawTextEx")]
	private static extern void DrawTextEx_Impl(in Font font, char8 *text, in Vector2 position, float fontSize, float spacing, in Color32 tint);
	
	/// Draw text using Font and pro parameters (rotation)
	[Inline]
	public static void DrawTextPro(Font font, char8 *text, Vector2 position, Vector2 origin, float rotation, float fontSize, float spacing, Color32 tint)
	{
		DrawTextPro_Impl(font, text, position, origin, rotation, fontSize, spacing, tint);
	}
	[LinkName("DrawTextPro")]
	private static extern void DrawTextPro_Impl(in Font font, char8 *text, in Vector2 position, in Vector2 origin, float rotation, float fontSize, float spacing, in Color32 tint);
	
	/// Draw one character (codepoint)
	[Inline]
	public static void DrawTextCodepoint(Font font, int32 codepoint, Vector2 position, float fontSize, Color32 tint)
	{
		DrawTextCodepoint_Impl(font, codepoint, position, fontSize, tint);
	}
	[LinkName("DrawTextCodepoint")]
	private static extern void DrawTextCodepoint_Impl(in Font font, int32 codepoint, in Vector2 position, float fontSize, in Color32 tint);
	
	/// Draw multiple character (codepoint)
	[Inline]
	public static void DrawTextCodepoints(Font font, int32 *codepoints, int32 codepointCount, Vector2 position, float fontSize, float spacing, Color32 tint)
	{
		DrawTextCodepoints_Impl(font, codepoints, codepointCount, position, fontSize, spacing, tint);
	}
	[LinkName("DrawTextCodepoints")]
	private static extern void DrawTextCodepoints_Impl(in Font font, int32 *codepoints, int32 codepointCount, in Vector2 position, float fontSize, float spacing, in Color32 tint);
	...
	/// Draw a line in 3D world space
	[Inline]
	public static void DrawLine3D(Vector3 startPos, Vector3 endPos, Color32 color)
	{
		DrawLine3D_Impl(startPos, endPos, color);
	}
	[LinkName("DrawLine3D")]
	private static extern void DrawLine3D_Impl(in Vector3 startPos, in Vector3 endPos, in Color32 color);
	
	/// Draw a point in 3D space, actually a small line
	[Inline]
	public static void DrawPoint3D(Vector3 position, Color32 color)
	{
		DrawPoint3D_Impl(position, color);
	}
	[LinkName("DrawPoint3D")]
	private static extern void DrawPoint3D_Impl(in Vector3 position, in Color32 color);
	
	/// Draw a circle in 3D world space
	[Inline]
	public static void DrawCircle3D(Vector3 center, float radius, Vector3 rotationAxis, float rotationAngle, Color32 color)
	{
		DrawCircle3D_Impl(center, radius, rotationAxis, rotationAngle, color);
	}
	[LinkName("DrawCircle3D")]
	private static extern void DrawCircle3D_Impl(in Vector3 center, float radius, in Vector3 rotationAxis, float rotationAngle, in Color32 color);
	
	/// Draw a color-filled triangle (vertex in counter-clockwise order!)
	[Inline]
	public static void DrawTriangle3D(Vector3 v1, Vector3 v2, Vector3 v3, Color32 color)
	{
		DrawTriangle3D_Impl(v1, v2, v3, color);
	}
	[LinkName("DrawTriangle3D")]
	private static extern void DrawTriangle3D_Impl(in Vector3 v1, in Vector3 v2, in Vector3 v3, in Color32 color);
	
	/// Draw a triangle strip defined by points
	[Inline]
	public static void DrawTriangleStrip3D(Vector3 *points, int32 pointCount, Color32 color)
	{
		DrawTriangleStrip3D_Impl(points, pointCount, color);
	}
	[LinkName("DrawTriangleStrip3D")]
	private static extern void DrawTriangleStrip3D_Impl(Vector3 *points, int32 pointCount, in Color32 color);
	
	/// Draw cube
	[Inline]
	public static void DrawCube(Vector3 position, float width, float height, float length, Color32 color)
	{
		DrawCube_Impl(position, width, height, length, color);
	}
	[LinkName("DrawCube")]
	private static extern void DrawCube_Impl(in Vector3 position, float width, float height, float length, in Color32 color);
	
	/// Draw cube (Vector version)
	[Inline]
	public static void DrawCubeV(Vector3 position, Vector3 size, Color32 color)
	{
		DrawCubeV_Impl(position, size, color);
	}
	[LinkName("DrawCubeV")]
	private static extern void DrawCubeV_Impl(in Vector3 position, in Vector3 size, in Color32 color);
	
	/// Draw cube wires
	[Inline]
	public static void DrawCubeWires(Vector3 position, float width, float height, float length, Color32 color)
	{
		DrawCubeWires_Impl(position, width, height, length, color);
	}
	[LinkName("DrawCubeWires")]
	private static extern void DrawCubeWires_Impl(in Vector3 position, float width, float height, float length, in Color32 color);
	
	/// Draw cube wires (Vector version)
	[Inline]
	public static void DrawCubeWiresV(Vector3 position, Vector3 size, Color32 color)
	{
		DrawCubeWiresV_Impl(position, size, color);
	}
	[LinkName("DrawCubeWiresV")]
	private static extern void DrawCubeWiresV_Impl(in Vector3 position, in Vector3 size, in Color32 color);
	
	/// Draw sphere
	[Inline]
	public static void DrawSphere(Vector3 centerPos, float radius, Color32 color)
	{
		DrawSphere_Impl(centerPos, radius, color);
	}
	[LinkName("DrawSphere")]
	private static extern void DrawSphere_Impl(in Vector3 centerPos, float radius, in Color32 color);
	
	/// Draw sphere with extended parameters
	[Inline]
	public static void DrawSphereEx(Vector3 centerPos, float radius, int32 rings, int32 slices, Color32 color)
	{
		DrawSphereEx_Impl(centerPos, radius, rings, slices, color);
	}
	[LinkName("DrawSphereEx")]
	private static extern void DrawSphereEx_Impl(in Vector3 centerPos, float radius, int32 rings, int32 slices, in Color32 color);
	
	/// Draw sphere wires
	[Inline]
	public static void DrawSphereWires(Vector3 centerPos, float radius, int32 rings, int32 slices, Color32 color)
	{
		DrawSphereWires_Impl(centerPos, radius, rings, slices, color);
	}
	[LinkName("DrawSphereWires")]
	private static extern void DrawSphereWires_Impl(in Vector3 centerPos, float radius, int32 rings, int32 slices, in Color32 color);
	
	/// Draw a cylinder/cone
	[Inline]
	public static void DrawCylinder(Vector3 position, float radiusTop, float radiusBottom, float height, int32 slices, Color32 color)
	{
		DrawCylinder_Impl(position, radiusTop, radiusBottom, height, slices, color);
	}
	[LinkName("DrawCylinder")]
	private static extern void DrawCylinder_Impl(in Vector3 position, float radiusTop, float radiusBottom, float height, int32 slices, in Color32 color);
	
	/// Draw a cylinder with base at startPos and top at endPos
	[Inline]
	public static void DrawCylinderEx(Vector3 startPos, Vector3 endPos, float startRadius, float endRadius, int32 sides, Color32 color)
	{
		DrawCylinderEx_Impl(startPos, endPos, startRadius, endRadius, sides, color);
	}
	[LinkName("DrawCylinderEx")]
	private static extern void DrawCylinderEx_Impl(in Vector3 startPos, in Vector3 endPos, float startRadius, float endRadius, int32 sides, in Color32 color);
	
	/// Draw a cylinder/cone wires
	[Inline]
	public static void DrawCylinderWires(Vector3 position, float radiusTop, float radiusBottom, float height, int32 slices, Color32 color)
	{
		DrawCylinderWires_Impl(position, radiusTop, radiusBottom, height, slices, color);
	}
	[LinkName("DrawCylinderWires")]
	private static extern void DrawCylinderWires_Impl(in Vector3 position, float radiusTop, float radiusBottom, float height, int32 slices, in Color32 color);
	
	/// Draw a cylinder wires with base at startPos and top at endPos
	[Inline]
	public static void DrawCylinderWiresEx(Vector3 startPos, Vector3 endPos, float startRadius, float endRadius, int32 sides, Color32 color)
	{
		DrawCylinderWiresEx_Impl(startPos, endPos, startRadius, endRadius, sides, color);
	}
	[LinkName("DrawCylinderWiresEx")]
	private static extern void DrawCylinderWiresEx_Impl(in Vector3 startPos, in Vector3 endPos, float startRadius, float endRadius, int32 sides, in Color32 color);
	
	/// Draw a capsule with the center of its sphere caps at startPos and endPos
	[Inline]
	public static void DrawCapsule(Vector3 startPos, Vector3 endPos, float radius, int32 slices, int32 rings, Color32 color)
	{
		DrawCapsule_Impl(startPos, endPos, radius, slices, rings, color);
	}
	[LinkName("DrawCapsule")]
	private static extern void DrawCapsule_Impl(in Vector3 startPos, in Vector3 endPos, float radius, int32 slices, int32 rings, in Color32 color);
	
	/// Draw capsule wireframe with the center of its sphere caps at startPos and endPos
	[Inline]
	public static void DrawCapsuleWires(Vector3 startPos, Vector3 endPos, float radius, int32 slices, int32 rings, Color32 color)
	{
		DrawCapsuleWires_Impl(startPos, endPos, radius, slices, rings, color);
	}
	[LinkName("DrawCapsuleWires")]
	private static extern void DrawCapsuleWires_Impl(in Vector3 startPos, in Vector3 endPos, float radius, int32 slices, int32 rings, in Color32 color);
	
	/// Draw a plane XZ
	[Inline]
	public static void DrawPlane(Vector3 centerPos, Vector2 size, Color32 color)
	{
		DrawPlane_Impl(centerPos, size, color);
	}
	[LinkName("DrawPlane")]
	private static extern void DrawPlane_Impl(in Vector3 centerPos, in Vector2 size, in Color32 color);
	
	/// Draw a ray line
	[Inline]
	public static void DrawRay(Ray ray, Color32 color)
	{
		DrawRay_Impl(ray, color);
	}
	[LinkName("DrawRay")]
	private static extern void DrawRay_Impl(in Ray ray, in Color32 color);
	...
	/// Draw a model (with texture if set)
	[Inline]
	public static void DrawModel(Model model, Vector3 position, float scale, Color32 tint)
	{
		DrawModel_Impl(model, position, scale, tint);
	}
	[LinkName("DrawModel")]
	private static extern void DrawModel_Impl(in Model model, in Vector3 position, float scale, in Color32 tint);
	
	/// Draw a model with extended parameters
	[Inline]
	public static void DrawModelEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color32 tint)
	{
		DrawModelEx_Impl(model, position, rotationAxis, rotationAngle, scale, tint);
	}
	[LinkName("DrawModelEx")]
	private static extern void DrawModelEx_Impl(in Model model, in Vector3 position, in Vector3 rotationAxis, float rotationAngle, in Vector3 scale, in Color32 tint);
	
	/// Draw a model wires (with texture if set)
	[Inline]
	public static void DrawModelWires(Model model, Vector3 position, float scale, Color32 tint)
	{
		DrawModelWires_Impl(model, position, scale, tint);
	}
	[LinkName("DrawModelWires")]
	private static extern void DrawModelWires_Impl(in Model model, in Vector3 position, float scale, in Color32 tint);
	
	/// Draw a model wires (with texture if set) with extended parameters
	[Inline]
	public static void DrawModelWiresEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color32 tint)
	{
		DrawModelWiresEx_Impl(model, position, rotationAxis, rotationAngle, scale, tint);
	}
	[LinkName("DrawModelWiresEx")]
	private static extern void DrawModelWiresEx_Impl(in Model model, in Vector3 position, in Vector3 rotationAxis, float rotationAngle, in Vector3 scale, in Color32 tint);
	
	/// Draw a model as points
	[Inline]
	public static void DrawModelPoints(Model model, Vector3 position, float scale, Color32 tint)
	{
		DrawModelPoints_Impl(model, position, scale, tint);
	}
	[LinkName("DrawModelPoints")]
	private static extern void DrawModelPoints_Impl(in Model model, in Vector3 position, float scale, in Color32 tint);
	
	/// Draw a model as points with extended parameters
	[Inline]
	public static void DrawModelPointsEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color32 tint)
	{
		DrawModelPointsEx_Impl(model, position, rotationAxis, rotationAngle, scale, tint);
	}
	[LinkName("DrawModelPointsEx")]
	private static extern void DrawModelPointsEx_Impl(in Model model, in Vector3 position, in Vector3 rotationAxis, float rotationAngle, in Vector3 scale, in Color32 tint);
	
	/// Draw bounding box (wires)
	[Inline]
	public static void DrawBoundingBox(BoundingBox @box, Color32 color)
	{
		DrawBoundingBox_Impl(@box, color);
	}
	[LinkName("DrawBoundingBox")]
	private static extern void DrawBoundingBox_Impl(in BoundingBox @box, in Color32 color);
	
	/// Draw a billboard texture
	[Inline]
	public static void DrawBillboard(Camera camera, Texture2D texture, Vector3 position, float scale, Color32 tint)
	{
		DrawBillboard_Impl(camera, texture, position, scale, tint);
	}
	[LinkName("DrawBillboard")]
	private static extern void DrawBillboard_Impl(in Camera camera, in Texture2D texture, in Vector3 position, float scale, in Color32 tint);
	
	/// Draw a billboard texture defined by source
	[Inline]
	public static void DrawBillboardRec(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector2 size, Color32 tint)
	{
		DrawBillboardRec_Impl(camera, texture, source, position, size, tint);
	}
	[LinkName("DrawBillboardRec")]
	private static extern void DrawBillboardRec_Impl(in Camera camera, in Texture2D texture, in Rectangle source, in Vector3 position, in Vector2 size, in Color32 tint);
	
	/// Draw a billboard texture defined by source and rotation
	[Inline]
	public static void DrawBillboardPro(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, Color32 tint)
	{
		DrawBillboardPro_Impl(camera, texture, source, position, up, size, origin, rotation, tint);
	}
	[LinkName("DrawBillboardPro")]
	private static extern void DrawBillboardPro_Impl(in Camera camera, in Texture2D texture, in Rectangle source, in Vector3 position, in Vector3 up, in Vector2 size, in Vector2 origin, float rotation, in Color32 tint);
